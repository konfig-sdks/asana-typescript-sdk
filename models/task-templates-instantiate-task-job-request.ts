 ...
 * 
 * @export
 * @interface TaskTemplatesInstantiateTaskJobRequest
 */
export interface TaskTemplatesInstantiateTaskJobRequest {
    /**
     * 
     * @type {TaskTemplateInstantiateTaskRequest}
     * @memberof TaskTemplatesInstantiateTaskJobRequest
     */
