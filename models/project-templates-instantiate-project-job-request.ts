 ...
 * 
 * @export
 * @interface ProjectTemplatesInstantiateProjectJobRequest
 */
export interface ProjectTemplatesInstantiateProjectJobRequest {
    /**
     * 
     * @type {ProjectTemplateInstantiateProjectRequest}
     * @memberof ProjectTemplatesInstantiateProjectJobRequest
     */
