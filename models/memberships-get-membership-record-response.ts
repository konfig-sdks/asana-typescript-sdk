 ...
 * 
 * @export
 * @interface MembershipsGetMembershipRecordResponse
 */
export interface MembershipsGetMembershipRecordResponse {
    /**
     * 
     * @type {ProjectMembershipCompactResponse}
     * @memberof MembershipsGetMembershipRecordResponse
     */
