...
type GoalMetricBaseAllOfResourceSubtypeEnum = 'number'
type GoalMetricBaseAllOfUnitEnum = 'none' | 'currency' | 'percentage'
type GoalMetricBaseAllOfProgressSourceEnum = 'manual' | 'subgoal_progress' | 'project_task_completion' | 'project_milestone_completion' | 'task_completion' | 'external'
